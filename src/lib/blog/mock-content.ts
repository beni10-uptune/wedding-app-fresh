...
Ready to start planning your perfect wedding soundtrack? UpTune makes it easy to organize, collaborate, and create the wedding music of your dreams.`,
  ...
  'perfect-wedding-timeline': `Creating a well-planned wedding timeline is essential for a smooth, stress-free celebration. When you integrate music planning into your timeline from the start, you ensure that every moment flows seamlessly into the next, creating an unforgettable experience for you and your guests.
...
// Export the mock posts with full content
export const mockBlogPosts: BlogPost[] = [
  {
    ...
    content: fullBlogContent['complete-guide-wedding-music-planning'],
    author: {
      id: '1',
      name: 'Sarah Mitchell',
  ...
  },
  {
    ...
    content: fullBlogContent['perfect-wedding-timeline'],
    author: {
      id: '2',
      name: 'UpTune Team',
  ...
  },
  {
    ...
    content: fullBlogContent['10-ways-guest-music-selection'],
    author: {
      id: '1',
      name: 'Sarah Mitchell',
      bio: 'Wedding music expert and content strategist at UpTune.',
  ...
  },
  {
    ...
    content: fullBlogContent['real-wedding-sarah-tom'],
    author: {
      id: '2',
      name: 'UpTune Team',
      bio: 'The UpTune team is dedicated to helping couples create their perfect wedding soundtrack.',
  ...
  },
  {
    ...
    content: fullBlogContent['wedding-reception-music-guide'],
    author: {
      id: '1',
      name: 'Sarah Mitchell',
      bio: 'Wedding music expert and content strategist at UpTune.',
